...
def create_full_profile_database():
    ...
    insert_patient_test_data(100)
    printProgressBar(34, 100, prefix='Progress:', suffix='Patients are signing up...         ', length=30)
    insert_patient_test_data(100)
    printProgressBar(36, 100, prefix='Progress:', suffix='Patients are signing up...         ', length=30)
    time.sleep(2)
    insert_patient_test_data(100)
    printProgressBar(38, 100, prefix='Progress:', suffix='Patients are signing up...         ', length=30)
    insert_patient_test_data(100)
